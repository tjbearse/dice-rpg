...
import {Die, Constant, Fixed, Max, Min, CountDown} from './model/dice';
...
const Actions = [
	...
	new TextAction("Sword of Double Testing", "a", [new Min(2), new Fixed(3)], "4 Damage"),
	new TextAction("Sword of Triple Testing", "b", [new Die("7"), new Min(3), new Min(3)], "4 Damage"),
